...
class ChatCompletionRequest(BaseModel):
    ...
    type: Optional[str] = Field("github", description="Type of repository (e.g., 'github', 'gitlab', 'bitbucket', 'gitea', 'gitee', 'local')")

    # model parameters
    provider: str = Field(
        "deepseek",
        description="Model provider (deepseek, vllm, ollama)",
    )
